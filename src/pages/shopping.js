...
const Shopping = ({ addToGlobalCart, addToGlobalList }) => {
  ...
  const addToLocalList = (product) => {
    setLocalList([...localList, product]);
    addToGlobalList(product);
  ...
  const [products] = useState([
    ...
    {
      img: "https://th.bing.com/th/id/OIP.zDXX5Zkm56mw5WANTQoyTAHaHa?w=176&h=180&c=7&r=0&o=5&pid=1.7",
      artist: "Usher",
      album: "Confessions (Expanded Edition)",
      price: "$15.99",
    },
    {
      img: "https://th.bing.com/th/id/R.0490f1714c67943be2faa7d2e5db19db?rik=RcJBGIaCSUtzBw&riu=http%3a%2f%2fwww.lyrics.by%2f__media%2fjay_sean%2fa2009a1-all-1500px.jpg&ehk=h84zUlJb5olfUYRjOYfFHeYY%2fd9QXzWUHMvZTc6Ju9M%3d&risl=&pid=ImgRaw&r=0",
      artist: "Jay Sean",
      album: "All or Nothing",
      price: "$11.99",
    },
    {
      img: "https://th.bing.com/th/id/OIP.LY_2xVKWJRKdm406TKiCRgHaHd?w=200&h=202&c=7&r=0&o=5&pid=1.7",
      artist: "TLC",
      album: "Fanmail",
      price: "$10.99",
    },
    ...
    {
      img: "https://th.bing.com/th/id/OIP.madF9TJ2ShKYG-bGn6lTEwHaHa?w=176&h=180&c=7&r=0&o=5&pid=1.7",
      artist: "Ashanti",
      album: "Ashanti",
      price: "$18.99",
    },
    {
      img: "https://th.bing.com/th/id/OIP.gnmL4dCX1iUwqRVvPGHIoQHaHc?w=169&h=180&c=7&r=0&o=5&pid=1.7",
      artist: "Jagged Edge",
